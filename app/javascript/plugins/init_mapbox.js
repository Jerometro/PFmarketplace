...
//   const getaddress = document.querySelector("#search");
//   const address = getaddress.value;
//   console.log(address);
...
//       mapboxgl.accessToken = 'pk.eyJ1IjoiajM1IiwiYSI6ImNrbmtlcHRtYzBhZWwyb28wY2h0ZXBubzcifQ.2EyMOZWpUGnmIoBnc4EdlQ';
...
// console.log(form);
// form.addEventListener("submit", getMap);
